...
#### ❌ Claude 5 or Opus 4.7+ Request Errors
**Problem**: `HTTP Error 400 ... temperature is deprecated for this model`
```
Solution: Remove sampling parameters for adaptive-thinking models.
1. Do not send `temperature`, `top_p`, or `top_k` for `claude-sonnet-5`,
   `claude-fable-5`, or `claude-opus-4-7` and later
